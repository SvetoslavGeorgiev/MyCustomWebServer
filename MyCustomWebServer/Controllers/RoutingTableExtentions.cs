namespace MyCustomWebServer.Controllers
{
    ...
    public static class RoutingTableExtentions
    {
        ...
        private static Type httpResponseType = typeof(ActionResult);
        ...
        private static IEnumerable<MethodInfo> GetControllerActions()
            => Assembly
                ...
                .SelectMany(t => t
                    ...
                    .Where(m => m.ReturnType.IsAssignableFrom(httpResponseType)))
                .ToList();
        ...
        private static Func<HttpRequest, HttpResponse> GetResponseFunction(MethodInfo controllerAction)
            => request =>
            {
                ...
                {
                    return new HttpResponse(HttpStatusCode.UNAUTHORISED);
                }
